...
public class BookPriceEvaluationRule extends EvaluationRule<Book, Attribute> {
	...
	public boolean isEqual(Book record1, Book record2, Attribute schemaElement) {
		...
		if(record1.getPrice()== null && record2.getPrice()==null)
			return true;
		else if(record1.getPrice()== null ^ record2.getPrice()==null)
			return false;
		else 
			return record1.getPrice().equals(record2.getPrice());
	}
